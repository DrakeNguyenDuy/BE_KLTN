...
//	Long add some lines here (20/5/2023)
	@Query("select r from CustomerReview r where r.id = ?1")
	CustomerReview findOne(Long id);
//	end
...
//	Long add some lines here (20/5/2023)
	@Query("select distinct r from CustomerReview r join fetch r.customer rc where rc.id = ?1")
	List<CustomerReview> findByReviewer(Long id);
//	end
...
//	Long add some lines here (20/5/2023)
	@Query("select distinct r from CustomerReview r join fetch r.customer rc join fetch r.reviewedCustomer rr where rr.id = ?1")
	List<CustomerReview> findByReviewed(Long id);
//	end
