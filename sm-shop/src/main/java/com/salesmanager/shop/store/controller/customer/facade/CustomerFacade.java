...
/**
 * <p>
 * Customer facade working as a bridge between {@link CustomerService} and
 * Controller It will take care about interacting with Service API and doing any
...
public interface CustomerFacade {
	...
	/**
	 * <p>
	 * Method responsible for merging cart during authentication, Method will
	 ...
	 * @param sessionShoppingCartId session shopping cart, if user already have few
	 *                              items in Cart.
	 * @throws Exception
	 */
...
//	end
	 ...
	 * @throws Exception
	 */
	PersistableCustomerReview saveOrUpdateCustomerReview(PersistableCustomerReview review, MerchantStore store,
			Language language);
	 ...
	 * @return
	 */
	List<ReadableCustomerReview> getAllCustomerReviewsByReviewed(Long customerId, MerchantStore store,
			Language language);
	...
	PersistableCustomerReview createCustomerReview(Long customerId, PersistableCustomerReview review,
			MerchantStore merchantStore, Language language);

	PersistableCustomerReview updateCustomerReview(Long id, Long reviewId, PersistableCustomerReview review,
